...
/* A constant that is used to store the data of the form. */
const formData = {
  email: '',
  password: '',
  displayName: ''
...
export const RegisterPage = () => {
  ...
  /* Destructuring the state of the auth reducer. */
  ...
  /* Destructuring the state of the form. */
  const {formState, displayName, email, password, onInputChange,
    isFormValid, displayNameValid, emailValid, passwordValid} = useForm( formData, formValidations)

  /**
   * If the form is valid, then dispatch the startCreatingUserWithEmailPassword function with the
   * formState as an argument.
  ...
  /* A React component that is rendering a form. */
  return (
